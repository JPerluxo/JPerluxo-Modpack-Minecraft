...
1. **Clone the repository:**
  ```bash
    git clone https://github.com/jperluxo/jperluxo-modpack-minecraft.git
...
6. **Available tasks:**
  ...
  - Packwiz: refresh — regenerate the pack index.
  - Packwiz: generate .mrpack — export the final release file.
...
3. **Install the mods:**
  - Wait for the launcher to download all mods automatically.

4. **Launch Minecraft:**
  - Launch the profile and play.

5. **Verify installation:**
  - Once Minecraft loads, click on **Mods** in the main menu.
  - You should see all **JPerluxo Modpack** mods listed there.
</details>
...
## [1.2.5] - 2026-07-04
### Updated
- Updated Xaero's Minimap, Xaero's World Map

## [1.2.0] - 2026-06-09
### Updated
- Changed custom main menu background and splashes

## [1.1.5] - 2026-06-05
### Added
- Added a custom main menu by Load My Resources mod

## [1.1.0] - 2026-05-28
### Added
- Added Not Enough Animations and Bl4ck's Sit mods
...
[1.2.5]: https://github.com/jperluxo/jperluxo-modpack-minecraft/compare/1.2.0...1.2.5
[1.2.0]: https://github.com/jperluxo/jperluxo-modpack-minecraft/compare/1.1.5...1.2.0
[1.1.5]: https://github.com/jperluxo/jperluxo-modpack-minecraft/compare/1.1.0...1.1.5
[1.1.0]: https://github.com/jperluxo/jperluxo-modpack-minecraft/compare/1.0.5...1.1.0
